...
import com.example.financialdashboard.api.service.CategoriaService;
...
public class CategoriaResource {
	...
	@PutMapping("/{codigo}")
	public Categoria atualizar(@Valid @RequestBody Categoria categoria, @PathVariable Long codigo){
