...
import com.example.financialdashboard.api.model.Lancamento_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery{
	...
	private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
		...
		if(!"".equals(lancamentoFilter.getDescricao())) {
		...
		if(lancamentoFilter.getDataVencimentoAte() != null) {
			System.out.println("True" + lancamentoFilter.getDataVencimentoAte());
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<Lancamento> query, Pageable pageable) {
		...
		int primeiroReistroDaPagina = paginaAtual * totalRegistrosPorPagina;
		
		query.setFirstResult(primeiroReistroDaPagina);
